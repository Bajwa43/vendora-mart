...
class ProductModel {
  ...
  String? description;
  List<String>? sizes;
  List<String> images; // List of images must always be provided
  ...
  factory ProductModel.fromMap(Map<String, dynamic> map) {
    return ProductModel(
      ...
      quantityOfProduct: map['quantityOfProduct'] != null
          ? map['quantityOfProduct'] as int
          : null,
    );
  }
  ...
  @override
  String toString() {
    return 'ProductModel(venderUid: $venderUid, productUid: $productUid, publish: $publish, productName: $productName, price: $price, fashionCategory: $fashionCategory, gender: $gender, fashionItem: $fashionItem, keyFeatures: $keyFeatures, description: $description, sizes: $sizes, images: $images, quantityOfProduct: $quantityOfProduct)';
  }
